...
Here is a list of products that you have to compare
%products%

Here is a list of product names you have already suggested. DO NOT SUGGEST THEM AGAIN. Take into account color variations etc
%already_suggested%
